				...
				<main className="mx-auto px-4 sm:px-6 lg:px-8">
					<div className="relative z-10 flex items-baseline justify-between pt-8 pb-6 border-b border-gray-200">
						...
						<NavSection
							healthcareposts="4"
							animalcareposts="3"
							workassistanceposts="3"
							educationassistanceposts="3"
						/>
											...
											{({open}) => (
												<>
													<h3 className="-my-3 flow-root">
														<Disclosure.Button className="p-4 rounded-lg focus:ring-1 focus:ring-indigo-600 hover:border-2 hover:border-indigo-600 bg-white w-full flex items-center justify-between text-sm text-gray-400 hover:text-gray-500">
															<span className="font-medium text-gray-900">
																{section.name}
															</span>
															<span className="ml-6 flex items-center">
