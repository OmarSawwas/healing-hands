...
const HealthFormDetails = (props) => {
	...
	const docRef = doc(db, "HealthCases", id);
	const fetchData = async () => {
		setLoading(true);

		const healthData = await getDoc(docRef);
						...
						<div className=" bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-1 sm:gap-4 sm:px-6 ">
							...
							<div>
								...
								<div className="bg-gray-100 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
									...
									<dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
										{data.extraAddressInfo}
									</dd>
								</div>
								<div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
									<dt className="text-sm font-medium text-gray-500">
										Extra information about case:
									</dt>
									<dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
										{data.infoAboutHealthProblem}
									</dd>
								</div>
								<div className="bg-gray-100  px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
									<dt className="text-sm font-medium text-gray-500">
...
export default HealthFormDetails;
